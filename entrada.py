...
# -*- coding: UTF8 -*-
#
# generated by wxGlade 0.7.1 on Thu Mar  9 20:44:23 2017
#
...
class Principal(wx.Frame):
    ...
    def __set_properties(self):
        ...
        # statusbar fields
        estatusbar_fields = [_("Sistema de Seleccion de Personal")]
    ...
    def OnClave(self, event):  # wxGlade: Principal.<event_handler>
        ...
        if len(Campo)> 16:
            dlg=wx.MessageDialog(self,'No puede ser mayor a 16 caracteres', 'Atencion', wx.OK)
            dlg.ShowModal()
            dlg.Destroy()
        else:
