...
class Principal(wx.Frame):
    ...
    def OnAdministrativo(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesAdministrativoSeleccionados(self)
        os.system('xdg-open "ReportePostulantesAdministrativoSeleccionados.pdf"')
        self.Hide()
    def OnChofer(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesChoferSeleccionados(self)
        os.system('xdg-open "ReportePostulantesChoferSeleccionados.pdf"')
        self.Hide() 
    def OnVigilante(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesVigilanteSeleccionados(self)
        os.system('xdg-open "ReportePostulantesVigilanteSeleccionados.pdf"')
        self.Hide()
    def OnGVentas(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesGerenteVSeleccionados(self)
        os.system('xdg-open "ReportePostulantesGerenteVSeleccionados.pdf"')
        self.Hide()
    def OnAVentas(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesAsistenteVSeleccionados(self)
        os.system('xdg-open "ReportePostulantesAsistenteVSeleccionados.pdf"')
        self.Hide()
    def OnAsistenteA(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesAsistenteSeleccionados(self)
        os.system('xdg-open "ReportePostulantesAsistenteSeleccionados.pdf"')
        self.Hide()         
    ...
    def OnAtencionC(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesAtencionCSeleccionados(self)
        os.system('xdg-open "ReportePostulantesAtencionCSeleccionados.pdf"')
        self.Hide() 
    def OnRecursos(self, event):  # wxGlade: Principal.<event_handler>
        FR.ReportePostulantesRecursosHSeleccionados(self)
        os.system('xdg-open "ReportePostulantesRecursosHSeleccionados.pdf"')
        self.Hide()
