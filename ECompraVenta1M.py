...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Menu Bar end
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Postulante Asistente en Ventas"))
        ...
        self.label_9 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfCree usted que tiene\ncapacidad de negocio?"))
        self.cobMecanica = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI"), _("NO"), _("MUY POCO")], style=wx.CB_DROPDOWN)
        self.label_6 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfPorque dejo su\nultimo trabajo?"))
        self.cobGTrabajo = wx.ComboBox(self, wx.ID_ANY, choices=[_("ME SENTIA UN POCO ESTANCADO Y DECIDI QUE NECESITABA NUEVOS RETOS QUE NO TENIA EN MI PUESTO ANTERIOR"), _("ESTOY INTERESADO EN UN PUESTO CON MAYOR RESPONSABILIDAD Y CREO QUE ESTE TRABAJO ME PUEDE OFRECER ESA OPORTUNIDAD"), _("NO ESTABA DE ACUERDO CON EL CARGO")], style=wx.CB_DROPDOWN)
        self.label_5 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue hace cuando se encuentra\nen situacion de estres?"))
        self.cobHoras = wx.ComboBox(self, wx.ID_ANY, choices=[_("ANALIZA LA SITUACION Y ABORDA LOS PROBLEMAS DE LA MANERA MAS EFICIENTE Y EFICAZ"), _("DEJA QUE LOS DEMAS HAGAN EL TRABAJO POR USTED"), _("PIERDE EL CONTROL DE LA SITUACION Y NO SABE QUE HACER")], style=wx.CB_DROPDOWN)
        ...
        self.label_9_copy_copy = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfHa mejorado sus conocimientos\nen el ultimo a\u00f1o?"))
        self.cobNormas = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI, HE AUMENTADO MIS CONOCIMIENTOS LABORALES"), _("NO, HE ESTADO ESTANCADO"), _("MUY POCO")], style=wx.CB_DROPDOWN)
        ...
        self.label_13_copy = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfCon los cambios de trabajo\nha mejorado la eficiencia?"))
        self.cobNormasS = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI, SOY MUCHO MAS EFICIENTE AHORA"), _("NO, SIGO IGUAL"), _("SI, HE ADQUIRIDO NUEVAS EXPERIENCIAS LABORALES")], style=wx.CB_DROPDOWN)
        self.label_3 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfTrabaja bajo presion?"))
        self.cobTransporte = wx.ComboBox(self, wx.ID_ANY, choices=[_("NO, PERO TENER UNA FECHA LIMITE ES UN MAL NECESARIO QUE TENEMOS QUE AFRONTAR LA MAYORIA"), _("NO, CREO QUE LAS FECHAS LIMITE SON UNA PREOCUPACION Y PREFIERO PODER IR A MI PROPIO RITMO"), _("SI, CREO QUE TRABAJO BIEN BAJO PRESION")], style=wx.CB_DROPDOWN)
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfPosee vehiculo propio?"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Postulante Asistente en Ventas"))
        self.SetSize((688, 595))
