...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.7.1 on Wed Mar 15 11:25:08 2017
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Menu Bar end
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Modificar Usuario"))
        ...
        self.bitmap_1 = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap("iconos/9152064-boton-de-nombre-de-usuario-y-contrasena-ademas-de-inicio-de-sesion-en-un-candado-para-acceso-seguro-.jpg", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Modificar Usuario"))
        self.SetSize((426, 422))
        ...
        self.txtClave2.SetMinSize((312, 32))
        self.txtClave2.Enable(False)
    ...
    def __do_layout(self):
        ...
        grid_sizer_1 = wx.FlexGridSizer(10, 4, 0, 0)
        ...
        grid_sizer_1.Add(self.txtClave2, 0, wx.EXPAND, 0)
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add((20, 20), 0, 0, 0)
    ...
    def OnBuscar(self, event):  # wxGlade: Principal.<event_handler>
        if len(self.txtUsuario.GetValue())==0:
                wx.MessageBox("No puede tener campos en blanco",
                              "Error")
                self.txtUsuario.SetBackgroundColour("red")
                self.txtUsuario.SetFocus()
                self.txtUsuario.Refresh()
        else:
            f.BuscarU(self)
            self.txtClave.Enable(True)
            self.txtClave2.Enable(True)
            self.cobTipo.Enable(True)
            self.txtApellido.Enable(True)
            self.txtCedula.Enable(True)
        ...
        if self.Validate():
            ...
            if rs1:
                ...
                if rs2:
                    ...
                    dlg=wx.MessageDialog(self,'Nombre de usuario no registrado, Verifique', 'Atencion', wx.OK)
                    dlg.ShowModal()
                    dlg.Destroy()
                ...
                dlg=wx.MessageDialog(self,'Cedula no Registrada, Verifique', 'Atencion', wx.OK)
                dlg.ShowModal()
                dlg.Destroy()
