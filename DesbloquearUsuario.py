...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.7.1 on Tue Mar 14 22:03:42 2017
#
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Menu Bar end
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Desbloquear Usuario"))
        ...
        self.button_1 = wx.Button(self, wx.ID_ANY, _("Desbloquear"))
    ...
    def OnDesbloquear(self, event):  # wxGlade: Principal.<event_handler>
        if self.Validate():
            dlg = wx.MessageDialog(None, '¿Desea Desbloquear?',
