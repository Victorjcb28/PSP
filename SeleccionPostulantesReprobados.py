...
class Principal(wx.Frame):
    ...
    def OnAdministrativo(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesAdministrativoReprobado(self)
        os.system('xdg-open "ReportePostulantesAdministrativoReprobado.pdf"')
        self.Hide()
    def OnChofer(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesChoferReprobado(self)
        os.system('xdg-open "ReportePostulantesChoferReprobado.pdf"')
        self.Hide() 
    def OnVigilante(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesVigilanteReprobado(self)
        os.system('xdg-open "ReportePostulantesVigilanteReprobado.pdf"')
        self.Hide()
    def OnGVentas(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesGerenteVReprobado(self)
        os.system('xdg-open "ReportePostulantesGerenteVReprobado.pdf"')
        self.Hide()
    ...
    def OnAsistenteA(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesAsistenteReprobado(self)
        os.system('xdg-open "ReportePostulantesAsistenteReprobado.pdf"')
        self.Hide()         
    def OnCajero(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesCajeroReprobado(self)
        os.system('xdg-open "ReportePostulantesCajeroReprobado.pdf"')
        self.Hide()        
    def OnAtencionC(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesAtencionCReprobado(self)
        os.system('xdg-open "ReportePostulantesAtencionCReprobado.pdf"')
        self.Hide() 
    def OnRecursos(self, event):  # wxGlade: Principal.<event_handler>
        FR.PostulantesRecursosHReprobado(self)
        os.system('xdg-open "ReportePostulantesRecursosHReprobado.pdf"')
        self.Hide()
