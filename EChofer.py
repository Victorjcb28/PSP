...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.cobExperiencia = wx.ComboBox(self, wx.ID_ANY, choices=[_("NO, PERO SOY UNA PERSONA QUE APRENDE RAPIDO Y MOTIVADA"), _("NO, PRO TENGO LOS CONOCIMIENTOS NECESARIOS PARA EL CARGO"), _("SI")], style=wx.CB_DROPDOWN)
        self.label_9 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue tipo de transporte maneja?"))
        self.cobMecanica = wx.ComboBox(self, wx.ID_ANY, choices=[_("LIVIANOS"), _("PESADOS"), _("AMBOS")], style=wx.CB_DROPDOWN)
        self.label_6 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfCuantos a\u00f1os de experiencia?"))
        self.cobGTrabajo = wx.ComboBox(self, wx.ID_ANY, choices=[_("0-2"), _("4-6"), _("6+")], style=wx.CB_DROPDOWN)
        self.label_5 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue sientes en un atasco de trafico?"))
        self.cobHoras = wx.ComboBox(self, wx.ID_ANY, choices=[_("FRUSTACION"), _("IRA"), _("ABURRIMIENTO")], style=wx.CB_DROPDOWN)
        self.label_2 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue tipo de licencia posee?"))
        self.cobTFuera = wx.ComboBox(self, wx.ID_ANY, choices=[_("2"), _("3"), _("4"), _("5")], style=wx.CB_DROPDOWN)
        ...
        self.cobLicencia = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI"), _("NO")], style=wx.CB_DROPDOWN)
        ...
        self.cobTransporte = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI"), _("NO")], style=wx.CB_DROPDOWN)
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfTrabajaria fuera de la ciudad?"))
        self.cobAccidente = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI"), _("NO"), _("SOLO SI ES OCASIONALMENTE")], style=wx.CB_DROPDOWN)
