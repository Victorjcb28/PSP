...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_2 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfTiene experiencia en \ntecnicas de comunicacion?"))
        self.cobTFuera = wx.ComboBox(self, wx.ID_ANY, choices=[_("MUCHA "), _("POCA"), _("NADA")], style=wx.CB_DROPDOWN)
        self.label_9_copy_copy = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue siente sobre tener \nvarias tareas al mismo tiempo?"))
        self.cobNormas = wx.ComboBox(self, wx.ID_ANY, choices=[_("NO ME MOLESTA"), _("PREFIERO UNA TAREA CADA VEZ"), _("PREFIERO TENER VARIAS TAREAS EN MARCHA AL MISMO TIEMPO")], style=wx.CB_DROPDOWN)
        self.label_11_copy_1 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfComenta a sus familiares\nlas funciones del trabajo?"))
        self.cobLicencia = wx.ComboBox(self, wx.ID_ANY, choices=[_("SI"), _("NO"), _("A VECES")], style=wx.CB_DROPDOWN)
        self.label_13_copy = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfCuantas veces te has tomado\nunos dias libres por estres?"))
        self.cobNormasS = wx.ComboBox(self, wx.ID_ANY, choices=[_("NUNCA"), _("DOS VECES O MAS"), _("MAS DE DOS VECES")], style=wx.CB_DROPDOWN)
        self.label_3 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfPor que dejo su ultimo\ntrabajo?"))
        self.cobTransporte = wx.ComboBox(self, wx.ID_ANY, choices=[_("ME SENTIA UN POCO ESTANCADO Y DECIDI QUE NECESITABA NUEVOS RETOS QUE NO TENIA EN MI PUESTO ANTERIOR"), _("ESTOY INTEREADO EN UN PUESTO CON MAYOR RESPONSABILIDAD Y CREO QUE ESTE TRABAJO ME PUEDE OFRECER ESA OPORTUNIDAD"), ""], style=wx.CB_DROPDOWN)
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfQue hace cuando esta en \nsituacion de estres?"))
        self.cobAccidente = wx.ComboBox(self, wx.ID_ANY, choices=[_("ANALIZA LA SITUACION Y ABORDA LOS PROBLEMAS DE LA MANERA MAS EFICIENTE Y EFICAZ"), _("DEJA QUE LOS DEMAS HAGAN EL TRABAJO POR USTED"), _("PIERDE EL CONTROL DE LA SITUACION Y NO SABE QUE HACER")], style=wx.CB_DROPDOWN)
