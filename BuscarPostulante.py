...
import re #validacion de correo
#Examenes
...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.cobMunicipio = wx.ComboBox(self.notebook_8_pane_1, wx.ID_ANY, choices=[])
        ...
        self.cobParroquia = wx.ComboBox(self.notebook_8_pane_1, wx.ID_ANY, choices=[])
        ...
        self.label_25 = wx.StaticText(self.notebook_9_pane_1, wx.ID_ANY, _("Servicio Militar:"))
        ...
        self.label_26 = wx.StaticText(self.notebook_10_pane_1, wx.ID_ANY, _("Cargo Postulado:"))
        self.cobCargoP = wx.ComboBox(self.notebook_10_pane_1, wx.ID_ANY, choices=[_("ADMINISTRACION"), _("ASISTENTE"), _("CAJERO"), _("CHOFER"), _("VIGILANTE"), _("GERENTE VENTAS"), _("ASISTENTE VENTAS"), _("SERVICIO AL CLIENTE"), _("RECURSOS HUMANOS")], style=wx.CB_DROPDOWN)
    ...
    def __set_properties(self):
        ...
        self.txtAnoG.Enable(False)
        self.cobContabilidad.SetMinSize((200, 36))
        self.cobContabilidad.Enable(False)
    ...
    def __do_layout(self):
        ...
        grid_sizer_4.Add(self.CobSexo, 0, wx.EXPAND, 3)
        grid_sizer_4.Add((20, 20), 0, 0, 0)
        ...
        grid_sizer_5.Add((20, 20), 0, 0, 0)
        grid_sizer_5.Add(self.label_24_copy, 0, 0, 0)
        ...
        grid_sizer_5.Add((20, 20), 0, 0, 0)
        grid_sizer_5.Add(self.label_25, 0, 0, 0)
        ...
        grid_sizer_1.Add((20, 20), 0, 0, 0)
        grid_sizer_1.Add(self.label_26, 0, 0, 0)
        grid_sizer_1.Add(self.cobCargoP, 0, wx.EXPAND, 0)
    ...
    def OnGuardar(self, event):  # wxGlade: Principal.<event_handler>
        ...
        elif len(self.txtCedula.GetValue())<=7:
            wx.MessageBox("La cedula no puede ser menor a 7 digitos",
                          "Error")
    ...
    def OnTEmpresa(self, event):  # wxGlade: Principal.<event_handler>
        ...
        if Campo=="NO":
            ...
            self.label_25.Enable(False)
            self.cobCargoP.Enable(False)
    def OnCorreo(self, event):  # wxGlade: Principal.<event_handler>
        pass
    def OnTelefono(self, event):  # wxGlade: Principal.<event_handler>
        pass
