...
class Principal(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wx.StaticText(self, wx.ID_ANY, _("Postulante Administrativo"))
        ...
        self.label_13_copy = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfHa tomado medicamentes \npara el estres?"))
        self.cobNormasS = wx.ComboBox(self, wx.ID_ANY, choices=[_("NUNCA"), _("OCASIONALMENTE"), _("MAS QUE OCASIONALMENTE")], style=wx.CB_DROPDOWN)
        ...
        self.label_7 = wx.StaticText(self, wx.ID_ANY, _(u"\u00bfAlguna vez has da\u00f1ado algo\ndebio a la presion?"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Postulante Administrativo"))
